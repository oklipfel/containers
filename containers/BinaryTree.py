...
class BinaryTree():
    ...
    def print_tree(self, traversal_type):
        ...
        as a reference on how to write recursive functions
    ...
    def to_list(self, traversal_type):
        ...
        A general programming principle is that
        a function should return its results
    ...
    def _height(node):
        ...
        return 1 (for the current node) plus the max of the
        left and right _heights calculated above
        '''
        if node is None:
            return -1
